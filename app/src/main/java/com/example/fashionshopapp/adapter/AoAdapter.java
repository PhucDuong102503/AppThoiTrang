...
public class AoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof MyViewHolder){
            ...
            myViewHolder.giasp.setText("Giá: đ" + decimalFormat.format(Double.parseDouble(sanPham.getGiasanpham())));
            myViewHolder.motasp.setText(sanPham.getMotasanpham());
    ...
    public class  MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            itemClickListener.onClick(view, getAdapterPosition(), false); //longclick se chuy thanh true
        }
    }
}
